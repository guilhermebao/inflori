  ...
  <div class="bg-gray-900">
      ...
      >
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img
              class="h-8 w-auto"
              src="/src/assets/img/logo-inflori.png"
              alt=""
            />
          </a>
        </div>
    ...
    <swiper-slide>
        <div class="card relative isolate overflow-hidden pt-14">
          <img
            src="/src/assets/img/emergencia.jpg"
            alt=""
          ...
          <div class="mx-12 max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center h-80">
              <h1
                class="text-4xl font-bold tracking-tight text-red-700 sm:text-6xl"
              >
                URGÊNCIAS ODONTOLÓGICAS
              </h1>
              <p class="mt-6 text-lg leading-8 text-white">
                DOR DE DENTE? Entre em contato AGORA e resolva de vez seu problema.
              </p>
        ...
        <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" />
          ...
          <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            ...
            <div class="text-center h-80">
              ...
              <p class="mt-6 text-lg leading-8 text-white">
                Para que seu sorriso seja o mais natural possível, o nosso
                projeto de novo sorriso leva em conta sua personalidade, traços
                faciais e seus desejos.
              </p>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="https://infloriclinica.com/lentes"
                  class="rounded-md bg-[#132035] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#132035ad] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#132035ad]"
                  >SAIBA MAIS</a
                >
              </div>
      ...
      <swiper-slide>
        <div class="card relative isolate overflow-hidden pt-14">
          <img
            src="/src/assets/img/img-1-2.jpg"
            alt=""
            class="absolute inset-0 -z-10 h-full w-full object-cover"
          />
          <!-- <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
        <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" />
          ...
          <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            ...
            <div class="text-center h-80">
              <h1
                class="text-4xl font-bold tracking-tight text-[#132035] sm:text-6xl"
              >
      ...
      <swiper-slide>
        <div class="card relative isolate overflow-hidden pt-14">
          <img
            src="/src/assets/img/img-1-3.jpg"
            alt=""
            class="absolute inset-0 -z-10 h-full w-full object-cover"
          />
          <!-- <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
          ...
          <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            ...
            <div class="text-center h-80">
              <h1
                class="text-4xl font-bold tracking-tight text-white sm:text-6xl"
              >
                TRATAMENTO COM MICROSCÓPIO
              </h1>
              <p class="mt-6 text-lg leading-8 text-white">
                Alta tecnologia nos tratamentos mais complexos. Onde a exigência
                por detalhes é maior. Elevando a margem de sucesso nos
                procedimentos de endodonticos (canal)
              </p>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="https://infloriclinica.com/lentes"
